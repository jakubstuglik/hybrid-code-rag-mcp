"""
validate_informica.py -- RAG validation tests for the Informica codebase.

Contains all 78 Informica-specific test cases (T01-T78) targeting the
Informica production index.  Run this any time you want to verify that
the informica index is healthy after a reindex, model swap, or parameter
change.

Usage (from project root):
    python project-configs/config_informica/validate_informica.py
    python project-configs/config_informica/validate_informica.py --alpha 0.5
    python project-configs/config_informica/validate_informica.py --category 1
    python project-configs/config_informica/validate_informica.py --test T01
    python project-configs/config_informica/validate_informica.py --verbose
    python project-configs/config_informica/validate_informica.py --json
"""

import sys
import os

# This file lives in project-configs/config_informica/ (two levels below project
# root).  Add project root and src/ to sys.path so imports work regardless of
...
TEST_CASES: List[TestCase] = [
    ...
    TestCase(
        ...
        description="Should find class summary/overview/declSection for TdmMain in MainDM.pas",
        pass_criteria=PassCriteria(
            node_types=[
                "class_summary",
                "class_summary_split",
    ...
    TestCase(
        ...
        pass_criteria=PassCriteria(
            node_types=["method_group", "method_group_split", "defProc", "declProc"],
            file_pattern=r"emar",
    ...
    TestCase(
        ...
        pass_criteria=PassCriteria(
            node_types=["defProc", "defProc_split", "method_group", "class_summary"],
    ...
    TestCase(
        ...
        pass_criteria=PassCriteria(
            node_types=["create_table", "sql_batch", "ddl_group"],
    ...
    TestCase(
        ...
        pass_criteria=PassCriteria(
            node_types=["procedure_header", "procedure_full", "procedure_body"],
    ...
    TestCase(
        ...
        description="Should find procedure body or header",
        pass_criteria=PassCriteria(
            node_types=["procedure_body", "procedure_full", "procedure_header"],
            file_pattern=r"SLS_ReliefExport_Bilety_Get",
            max_position=4,
            partial_position=6,
        ),
    ...
    TestCase(
        ...
        pass_criteria=PassCriteria(
            file_pattern=r"(?i)Splash(Screen)?\.(pas|dfm)",
            max_position=5,
            partial_position=8,
        ),
        difficulty="Hard",
    ...
    TestCase(
        ...
        description="Should find REPORT_TYPE or C_REPORT_ constants, or report type definition files",
        pass_criteria=PassCriteria(
            text_pattern=r"(?i)(REPORT_TYPE|C_REPORT_|report.*type|type.*report)",
            max_position=5,
            partial_position=8,
        ),
        difficulty="Hard",
    ...
    TestCase(
        ...
        pass_criteria=PassCriteria(
            ...
            file_pattern=r"Creator_BaseFrame\.(pas|dfm)",
            max_position=3,
            partial_position=5,
        ),
        difficulty="Medium",
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Config name or path (default: config_informica)",
    )
    parser.add_argument(
        "--alpha",
        type=float,
    ...
    # Setup index
    config_name = args.config or "config_informica"
    index, mode, alpha, cfg = setup(config_name=args.config or "config_informica", alpha_override=args.alpha)
    top_k = args.top_k
