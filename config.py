...
#   - project-configs/config_myproject/config.py  (Delphi/SQL codebase)
...
#
# Usage:
#   python src/index_rag.py --config config_myproject --yes
#   python src/rag_mcp.py --config config_myproject --transport stdio
#
